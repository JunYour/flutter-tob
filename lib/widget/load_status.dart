...
///视图状态
enum LoadState { State_Success, State_Error, State_Loading, State_Empty,State_No_Network }
  ...
  Widget get _errorView {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.asset("assets/loadError.png",width: 300.w,height: 250.w,),
          Text("加载失败，请重试"),
          ElevatedButton(
  ...
  Widget get _noNetWorkView{
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Image.asset("assets/network.png",width: 300.w,height: 250.w,),
          Text("没有网络，请连接后重试"),
          ElevatedButton(
            onPressed: widget.errorRetry,
            child: Text(
