...
carReceiveListEntityFromJson(CarReceiveListEntity data, Map<String, dynamic> json) {
	if (json['count'] != null) {
	...
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => CarReceiveListList().fromJson(v)).toList();
	}
	if (json['page'] != null) {
...
Map<String, dynamic> carReceiveListEntityToJson(CarReceiveListEntity entity) {
...
carReceiveListListFromJson(CarReceiveListList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> carReceiveListListToJson(CarReceiveListList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
