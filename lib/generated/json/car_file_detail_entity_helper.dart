...
carFileDetailEntityFromJson(CarFileDetailEntity data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'] is String
				? int.tryParse(json['id'])
				: json['id'].toInt();
	}
	if (json['car_order_id'] != null) {
		data.carOrderId = json['car_order_id'] is String
				? int.tryParse(json['car_order_id'])
				: json['car_order_id'].toInt();
	}
	...
	if (json['client_mobile_remarks'] != null) {
		data.clientMobileRemarks = json['client_mobile_remarks'];
	}
	...
	if (json['license_f_remarks'] != null) {
		data.licenseFRemarks = json['license_f_remarks'];
	}
	...
	if (json['cert_remarks'] != null) {
		data.certRemarks = json['cert_remarks'];
	}
	...
	if (json['invoice_remarks'] != null) {
		data.invoiceRemarks = json['invoice_remarks'];
	}
	...
	if (json['certificate_image_remarks'] != null) {
		data.certificateImageRemarks = json['certificate_image_remarks'];
	}
	...
	if (json['client_id_z_image_remarks'] != null) {
		data.clientIdZImageRemarks = json['client_id_z_image_remarks'];
	}
	...
	if (json['client_id_f_image_remarks'] != null) {
		data.clientIdFImageRemarks = json['client_id_f_image_remarks'];
	}
	if (json['examinetime'] != null) {
		data.examinetime = json['examinetime'];
	}
	if (json['business_image'] != null) {
		data.businessImage = json['business_image'].toString();
	}
	if (json['business_image_state'] != null) {
		data.businessImageState = json['business_image_state'].toString();
	}
	...
	if (json['business_mobile'] != null) {
		data.businessMobile = json['business_mobile'].toString();
	}
	if (json['business_code'] != null) {
		data.businessCode = json['business_code'].toString();
	}
	if (json['register_type'] != null) {
		data.registerType = json['register_type'] is String
				? int.tryParse(json['register_type'])
				: json['register_type'].toInt();
	}
	return data;
}

Map<String, dynamic> carFileDetailEntityToJson(CarFileDetailEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['car_order_id'] = entity.carOrderId;
